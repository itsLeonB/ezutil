...
// RunServer initializes and runs an HTTP server with graceful shutdown support.
// It loads configuration using the provided defaults, invokes serverSetupFunc, and handles shutdown.
